...
/*
  $Id: Cartan.m 60693 2020-01-29 05:24:55Z don $

  Arjeh Cohen, Scott H Murray and D E Taylor

  30 November 2000

  2019-06-20 (DET) Removed the definition of 'NumPosRoots' because
    this is defined as a synonym for NumberOfPositiveRoots in the
    bind file n.b
  ...
  1. Coxeter matrices
     ...
     and m_ij = infinity or m_ij > 1 for i ne j.
...
//        end if;
  ...
  checkRank := procedure( type, rank, ndx )
    ...
    when "F":
      if rank ne 4 then
        err("For type F, the rank must be 4",str,ndx);
      end if;
    when "G":
      if rank ne 2 then
