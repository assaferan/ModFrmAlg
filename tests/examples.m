...
ExampleRF := recformat< group : MonStgElt,
		        field : Fld,
...
function createExamples_7_4()
    ...
    Example_7_4_W_3_1 := rec<ExampleRF | group := "Unitary",
			 field := QuadraticField(-7),
			 inner_form := inner_form,
			 coeff_char := 0,
			 genus := 2,
    ...
    Example_7_4_W_3_3 := rec<ExampleRF | group := "Unitary",
			 field := QuadraticField(-7),
			 inner_form := inner_form,
			 coeff_char := 0,
			 genus := 2,
    ...
    Example_7_4_W_4_0 := rec<ExampleRF | group := "Unitary",
			       field := QuadraticField(-7),
			       inner_form := inner_form,
			       coeff_char := 0,
			       genus := 2,
    ...
    Example_7_4_W_2_2 := rec<ExampleRF | group := "Unitary",
			       field := QuadraticField(-7),
			       inner_form := inner_form,
			       coeff_char := 0,
			       genus := 2,
