...
/****-*-magma-******a********************************************************
   ...
   03/06/2020 : Fixed HyperbolizeForm, realized that for all dim > 1, 
                one has an isotropic vector, and can find it using square
                root in the underlying finite field.
   03/05/2020 : Started this file
...
function ReflexiveForm(M, alpha)
  MS := Parent(M);
  n := Degree(MS);
